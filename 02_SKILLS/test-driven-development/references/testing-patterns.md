...
- [Browser / System Testing](#browser--system-testing)
...
1. Navigate to the application and authenticate
2. Create a task through the real UI
3. Verify the new task is visible
4. Complete the task through the real UI
5. Verify the final UI state matches expectations
```

Use the browser/system test runner that fits the project. The important part is to verify the full user-visible flow in the real runtime, not to depend on a specific framework.
